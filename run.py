...
def main():
    ...
    opt.color_weight = 1.2
    opt.color_adapter_ckpt = 'models/t2iadapter_color_sd14v1.pth'
    opt.style_adapter_ckpt = 'models/t2iadapter_style_sd14v1.pth'
    opt.color_path = opt.color
    opt.style_path = opt.style
    # process argument
    activated_conds = []
    cond_paths = []
    adapter_ckpts = []
